...
namespace IC.Client.BusinessLogic.ControlsBusinessLogic
{
    ...
    public class ProductByShare : IProductByShare
    {
        ...
        public ProductByShare(IBusinessLogicEntry businessLogicEntry, IPluginManager pluginManager)
        {
            ...
            _productByShareControl.KeyHook = _pluginManager.KeyHook;
        ...
        public void SetProductByShareData(ProductInfoData productInfoData)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(productInfoData.TextBoxProductInfo))
                    _productByShareControl.SetProductByShareInfo(productInfoData.TextBoxProductInfo);
                ...
                if (!string.IsNullOrEmpty(productInfoData.TextBoxProductName))
                    _productByShareControl.SetProductName(productInfoData.TextBoxProductName);
