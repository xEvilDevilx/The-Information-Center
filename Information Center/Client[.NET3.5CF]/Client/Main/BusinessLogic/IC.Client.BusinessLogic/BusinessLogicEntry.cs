...
using IC.Client.BusinessLogic.ControlsBusinessLogic;
...
namespace IC.Client.BusinessLogic
{
    ...
    public class BusinessLogicEntry : IBusinessLogicEntry
    {
        ...
        /// <summary>Presents Hardware Manager business logic</summary>
        public IHardwareManager HardwareManager { get; private set; }
        ...
        public BusinessLogicEntry(IPluginManager pluginManager)
        {
            ...
            pluginManager.KeyHook.Start();
            //HardwareManager = new HardwareManager(pluginManager);
