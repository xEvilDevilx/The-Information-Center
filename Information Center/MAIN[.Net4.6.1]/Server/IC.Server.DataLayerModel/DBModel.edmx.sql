...
-- --------------------------------------------------
-- Date Created: 04/15/2018 00:06:21
-- Generated from EDMX file: G:\DEVELOPMENT\Information Center\MAIN[.Net4.6.1]]\Server\IC.Server.DataLayerModel\DBModel.edmx
-- --------------------------------------------------
...
-- Creating primary key on [ConfigID], [StoreID], [TerminalID] in table 'Config'
ALTER TABLE [dbo].[Config]
ADD CONSTRAINT [PK_Config]
    PRIMARY KEY CLUSTERED ([ConfigID], [StoreID], [TerminalID] ASC);
GO
...
-- Creating primary key on [CurrencyCode], [StoreID] in table 'CurrencyRate'
ALTER TABLE [dbo].[CurrencyRate]
ADD CONSTRAINT [PK_CurrencyRate]
    PRIMARY KEY CLUSTERED ([CurrencyCode], [StoreID] ASC);
GO
...
-- Creating primary key on [StoreID], [ProductID], [RetailActionID] in table 'ProductAction'
ALTER TABLE [dbo].[ProductAction]
ADD CONSTRAINT [PK_ProductAction]
    PRIMARY KEY CLUSTERED ([StoreID], [ProductID], [RetailActionID] ASC);
GO
...
-- Creating primary key on [TerminalID], [StoreID], [CurrencyCode] in table 'TerminalCurrency'
ALTER TABLE [dbo].[TerminalCurrency]
ADD CONSTRAINT [PK_TerminalCurrency]
    PRIMARY KEY CLUSTERED ([TerminalID], [StoreID], [CurrencyCode] ASC);
GO

-- Creating primary key on [TerminalID], [StoreID], [LanguageCode] in table 'TerminalLanguage'
ALTER TABLE [dbo].[TerminalLanguage]
ADD CONSTRAINT [PK_TerminalLanguage]
    PRIMARY KEY CLUSTERED ([TerminalID], [StoreID], [LanguageCode] ASC);
GO
